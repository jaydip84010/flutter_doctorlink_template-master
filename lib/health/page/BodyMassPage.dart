...
class _BodyMassPage extends State<BodyMassPage> implements AdsInterfaces{
  ...
  Widget build(BuildContext context) {
    ...
    return ConstantWidget.getMainDefaultWidget(context, getWidget(), rowItem!, _requestPop,"Body mass",adsFile: adsFile);
    ...
    return  ListView(
      children: [
        ...
        ConstantWidget.getButtonWidget(
            context, themeColor, S.of(context).bmiChart,rowItem!.link!,
            (type) {
