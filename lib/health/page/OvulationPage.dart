...
class _OvulationPage extends State<OvulationPage> implements AdsInterfaces {
  ...
  Widget build(BuildContext context) {
    ...
    return ConstantWidget.getMainDefaultWidget(
        context, getWidget(), rowItem!, _requestPop,"Ovulation period",adsFile:  adsFile);
  }
        ...
        builder: (context, child) {
          return Theme(
            data: ThemeData.light().copyWith(
              ...
              colorScheme: ColorScheme.light(primary: themeColor,secondary: themeColor),
